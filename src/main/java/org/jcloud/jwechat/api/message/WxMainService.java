package org.jcloud.jwechat.api.message;
...
import org.jcloud.jwechat.bean.message.event.*;
import org.jcloud.jwechat.bean.message.receive.*;
import org.jcloud.jwechat.bean.message.send.OutBaseMessage;
import org.jcloud.jwechat.config.WxConfig;
import org.jcloud.jwechat.constant.WxMessageConstant;
import org.jcloud.jwechat.enums.EventTypeEnum;
import org.jcloud.jwechat.enums.MsgTypeEnum;
import org.jcloud.jwechat.handler.event.WxBaseEventHandler;
import org.jcloud.jwechat.handler.message.WxBaseMessageHandler;
import org.jcloud.jwechat.util.*;
    ...
    private String handleXmlInfo(MsgTypeEnum msgTypeEnum, String xmlInfo,String timestamp,String nonce) {
        ...
        if (msgTypeEnum.equals(MsgTypeEnum.EVENT)) {
            ...
            if (ObjectUtil.isNotNull(baseEvent)) {
                String beanName = eventTypeEnum.getName().concat(WxMessageConstant.EVENT_HANDLER_BEAN_POST_FIX);
            ...
            if (ObjectUtil.isNotNull(baseMessage)) {
                String beanName = msgTypeEnum.getName().concat(WxMessageConstant.MESSAGE_HANDLER_BEAN_POST_FIX);
